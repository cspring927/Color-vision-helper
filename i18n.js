...
const I18N = {
  zh: {
    ...
    modeCorrection: "校正模式",
    modeSimulation: "模拟模式",
    correctionDesc: "帮助色盲用户区分颜色",
    simulationDesc: "体验色盲眼中的世界",
    expand: "展开",
    collapse: "收起",
    protanopia: "红色盲",
    deuteranopia: "绿色盲",
  ...
  en: {
    ...
    correctionDesc: "Help color blind users distinguish colors",
    simulationDesc: "See the world through color blind eyes",
    expand: "Expand",
    collapse: "Collapse",
  ...
  fr: {
    ...
    modeCorrection: "Correction",
    modeSimulation: "Simulation",
    correctionDesc: "Aide les daltoniens à distinguer les couleurs",
    simulationDesc: "Voir le monde à travers les yeux des daltoniens",
    expand: "Développer",
    collapse: "Réduire",
  ...
  es: {
    ...
    modeSimulation: "Simulación",
    correctionDesc: "Ayuda a los daltónicos a distinguir colores",
    simulationDesc: "Ver el mundo a través de ojos daltónicos",
    expand: "Expandir",
    collapse: "Contraer",
  ...
  ru: {
    ...
    modeCorrection: "Коррекция",
    modeSimulation: "Симуляция",
    correctionDesc: "Помогает различать цвета",
    simulationDesc: "Мир глазами дальтоника",
    expand: "Развернуть",
    collapse: "Свернуть",
  ...
  ar: {
    ...
    modeCorrection: "تصحيح",
    modeSimulation: "محاكاة",
    correctionDesc: "مساعدة المصابين بعمى الألوان على التمييز",
    simulationDesc: "شاهد العالم بعيون مصابي عمى الألوان",
    expand: "توسيع",
    collapse: "طي",
